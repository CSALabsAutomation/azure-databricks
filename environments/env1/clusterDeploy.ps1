...
$BODY = @"
{"cluster_name": "dbcluster", "spark_version": "11.3.x-scala2.12", "autotermination_minutes": 30, "num_workers": "4", "node_type_id": "Standard_DS3_v2", "driver_node_type_id": "Standard_DS3_v2" }
"@
